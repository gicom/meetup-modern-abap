  ...
  return {
    ...
    k: {
      keyword:
        ...
        " BOUND MESSAGING CHANNELS HDB PROCEDURE SQLSCRIPT OPTIONS CROSS SECONDS CLASS ENDCLASS METHOD ENDMETHOD|10 DO FORM IF LOOP MODULE START-OF_FILE DEFINE WHILE BEGIN ENDDO ENDFORM|10 ENDIF ENDLOOP ENDMODULE END-OF_FILE END-OF-DEFINITION ENDWHILE END CHAIN ENDCHAIN CASE ENDCASE FUNCTION ENDFUNCTION ELSEIF ELSE TRY ENDTRY|10 CATCH COND SWITCH CAST CONV FIELD SYMBOL",
